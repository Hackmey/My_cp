...
//There are three implementations of suffix arrays n2logn, nlog sq n, nlogn
//The one that uses radix sort / counting sort for sorting is the fastest one. nlogn

//kasai algorithm creates lcp array in linear time.
//kasai algo uses the idea of using the minimum lcp that has been calculated before.
// for eg. if bananaban, ban, anaban, ananaban are 4 suffix and we know that
// bananaban has 3 lcp thenit is sure that ananaban will have 2 lcp.
...
public class SuffixArray
{
    ...
    public static int[] kasaiAlgorithm(String orgnlString, int[] suffixVector) {
